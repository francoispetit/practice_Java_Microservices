...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/api/products/lookup", "/api/items/lookup", "/api/users/users").permitAll()
		.antMatchers(HttpMethod.GET, "/api/products/lookup{id}", "/api/items/lookup/{id}/quantity/{quantity}",
